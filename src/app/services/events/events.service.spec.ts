...
describe('EventsService', () => {
  ...
  describe('isEventCreator', () => {
    it('should return if the event creator is the current user', () => {
  ...
  describe('subscribe', () => {
    ...
    let response;
      ...
      http.expectOne('http://localhost:8080/api/events/' + eventId + '/subscribe').flush(subscribeResponse);
  ...
  describe('create', () => {
    it('should return an event object with valid event details', () => {
      ...
      http.expectOne('http://localhost:8080/api/events')
        .flush(eventResponse);
  ...
  describe('getUserEvents', () => {
    ...
    it('should return a 500 if an error occurs', () => {
      const user = '5a55135639fbc4ca3eee0ce5b';
  ...
  describe('update', () => {
    it('should return an updated event with valid event details.', () => {
      ...
      service.update(updatedEvent).subscribe(res => {
        response = res;
      });
    ...
    it('should return a 500 with invalid event details', () => {
      ...
      service.update(event).subscribe(res => {}, err => {
        errorResponse = err;
      });
