...
describe('AuthService', () => {
  ...
  describe('signup', () => {
    it('should reutrn a user object with a valid username and password', () => {
      const user = { 'username' : 'myUser', 'password' : 'password' };
      const signupResponse = {
        '__v' : 0,
        'username' : 'myUser',
        'password': '$2a$10$MuryKmeANwLqaXkMPKggo.kT5Vii1VMLuZU7eETBuUZ3za9YScB9m',
        '_id' : '60694501a0ce773900a1140d',
        'dietPreferences' : []
      };
