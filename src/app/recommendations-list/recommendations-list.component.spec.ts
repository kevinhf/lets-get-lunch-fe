...
class MockRemmendationsService {
  get() {}
}
...
describe('RecommendationsListComponent', () => {
        ...
        providers: [
          {
            ...
            useClass: MockRemmendationsService
          }
        ]
      }
    })
  ...
  describe('with a response of recommendations', () => {
    beforeEach(() => {
      ...
      spyOn(recommendationsService, 'get').and.callFake(() => of(recommendationsResult));
      fixture.detectChanges();
    });

    it('should intialize with a call to the recommendations service', () => {
  ...
  describe('with an event that has suggestLocations set to false', () => {
    ...
    it('should not display the recommendations view', () => {
      const recommendationsView = fixture.debugElement.query(By.css('.recommendations-container'));
