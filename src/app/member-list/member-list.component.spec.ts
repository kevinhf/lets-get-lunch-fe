...
describe('MemberListComponent', () => {
  ...
  describe('viewed by the event creator', () => {
    ...
    it('should displayt the event creator in the member list', () => {
  ...
  describe('viewed by a non-event creator', () => {
    ...
    it('should update the member list when the subscribe button is clicked', () => {
      spyOn(eventsService, 'subscribe').and.callFake(() => of(updatedEvent));
      ...
      const members = fixture.debugElement.queryAll(By.css('.member'));
      expect(members[1].nativeElement.textContent).toEqual('bob');
    ...
    it('should show an error if a subscribe fails', () => {
      ...
      expect(errorMessage.nativeElement.textContent).toEqual('Something went wrong. Try again.');
